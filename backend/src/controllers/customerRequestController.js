...
const PROPERTY_MATCH_MAP = {
  ...
  Plot: ["Plot", "Land"],
  "Commercial Land": ["Commercial Land", "Commercial", "Commercial Land / Building"],
  "Agricultural Land": ["Agricultural Land", "Land", "Agri Land", "Farmland"],
  "Agri Land": ["Agri Land", "Agricultural Land", "Farmland", "Land"],
  Farmland: ["Farmland", "Agricultural Land", "Agri Land", "Land"],
  Flat: ["Flat", "Apartment"],
  "Commercial Land / Building": ["Commercial Land / Building", "Commercial Land & Building", "Commercial", "Commercial Building"],
  "Commercial Land & Building": ["Commercial Land & Building", "Commercial Land / Building", "Commercial"],
  "Rental Income Building": ["Rental Income Building", "Commercial Land & Building", "House", "Apartment", "Commercial"],
  "Warehouse / Industry": ["Warehouse / Industry", "Warehouse", "Industrial Shed"],
  PG: ["PG", "Rent", "Apartment", "House"],
  Rent: ["Rent", "House", "Flat", "Apartment", "Villa", "Independent House"],
  "Empty Land": ["Empty Land", "Land", "Plot"],
  Commercial: ["Commercial", "Office", "Commercial Land / Building"],
  Office: ["Office", "Commercial"],
  Warehouse: ["Warehouse", "Warehouse / Industry", "Industrial Shed"],
  Land: ["Land", "Plot", "Empty Land", "Agricultural Land", "Agri Land", "Farmland"],
