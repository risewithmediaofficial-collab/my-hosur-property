    ...
    <div className="location-cascade-container space-y-3">
      <div className="flex items-center justify-between">
        <p className="text-xs font-bold uppercase tracking-wider text-slate-500">
          {t("filters.locationFilters") || "Location Filters"}
        </p>
        {(country !== "India" || state || district || taluk || village || locality) && (
          ...
          >
            {t("filters.clearLocation") || "Clear Location"}
          </button>
        )}
      </div>
      ...
      <div className="grid gap-2.5 sm:grid-cols-1">
        ...
        <div>
          ...
          >
            <option value="">{t("filters.selectCountry") || "Select Country"}</option>
        ...
        <div>
          ...
          >
            <option value="">{t("filters.selectState") || "Select State"}</option>
            {stateList.map((item) => (
              <option key={item.id} value={item.id}>
                {item.name}
              </option>
        ...
        <div>
          ...
          >
            <option value="">{t("filters.selectDistrict") || "Select District"}</option>
        ...
        <div>
          ...
          >
            <option value="">{t("filters.selectTaluk") || "Select Taluk"}</option>
            {talukList.map((item) => (
              <option key={item.id} value={item.id}>
                {item.name}
              </option>
        ...
        <div>
          ...
          >
            <option value="">{t("filters.selectVillage") || "Select Village"}</option>
        ...
        <div>
          ...
          >
            <option value="">{t("filters.selectArea") || "Select Area / Locality"}</option>
